...
const Message = () => {
    ...
    const loadMessage = async () => {
        ...
        const res = await authApi().get((endpoints['my-message'](user.id)))
                    ...
                    <div className="card ">
                        <div className="row g-0">
                            ...
                            <div className="col-12 col-lg-7 col-xl-9">
                                ...
                                {/* <div className="flex-shrink-0 py-3 px-4 border-t">
                                ...
                                <div class="flex-shrink-0 py-3 px-4 border-t">
                                    <div class="flex justify-between ">
                                        <input
                                            ...
                                            placeholder="Type your message"
                                        />
                                        <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 ml-2 rounded">
                                            Send
                                        </button>
                                    </div>
                                </div>
